...
#        individual_action[self.prob_infecious > 0.01] = 1
#        individual_action[self.prob_infecious > 0.01] = 2
        individual_action[self.prob > 0.001] = 1
        individual_action[self.prob > 0.01] = 3
        individual_action[self.prob > 0.1] = 3
